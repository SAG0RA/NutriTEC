package com.sagora.nutritecmovil.Database.Cliente
...
import com.sagora.nutritecmovil.Database.Tablas

class ClienteDB(context: Context): SQLiteOpenHelper(context, DATABASE_NAME,null, DATABASE_VERSION) {
